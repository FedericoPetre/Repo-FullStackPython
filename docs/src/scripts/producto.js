export default class Producto{
    ...
    toCardHTMLElement(){
        let cardHTML = `
        <div class="product" id="txtProducto${this.idProducto}" productoJson='${JSON.stringify(this)}' >
